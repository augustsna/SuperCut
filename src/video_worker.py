    ...
    def _process_batch(self, mp3_files: List[str], image_files: List[str], 
        ...
        try:
            ...
            success, err = create_video_with_ffmpeg(
                ...
                overlay8_effect="null" if self.overlay8_popup_checkbox_checked else self.overlay8_effect,
                ...
                overlay9_effect="null" if self.overlay9_popup_checkbox_checked else self.overlay9_effect,
