...
class SuperCutUI(QWidget):
    ...
    def create_video_settings(self, layout):
        ...
        edit_medium_width = 100        

        edit_short_width = 35  

        label_micro_width = 20   

        label_mini_width = 30 

        label_short_width = 46       

        label_medium_width = 55
        ...
        intro_btn.setFixedWidth(file_btn_width)
        ...
        intro_size_label.setFixedWidth(label_micro_width)
        intro_size_label.setFixedHeight(unified_height)
        self.intro_size_combo = NoWheelComboBox()
        self.intro_size_combo.setFixedWidth(combo_mini_width)
        ...
        intro_x_label.setFixedWidth(label_micro_width)
        intro_x_label.setFixedHeight(unified_height)
        self.intro_x_combo = NoWheelComboBox()
        self.intro_x_combo.setFixedWidth(combo_mini_width)
        ...
        intro_y_label.setFixedWidth(label_micro_width)
        intro_y_label.setFixedHeight(unified_height)
        self.intro_y_combo = NoWheelComboBox()
        self.intro_y_combo.setFixedWidth(combo_mini_width)
        ...
        intro_effect_label.setFixedWidth(label_short_width)
        intro_effect_label.setFixedHeight(unified_height)
        self.intro_effect_combo = NoWheelComboBox()
        self.intro_effect_combo.setFixedWidth(edit_long_width)
        ...
        intro_duration_full_label.setFixedWidth(label_mini_width)
        ...
        intro_duration_label.setFixedWidth(label_mini_width)
        ...
        intro_start_at_label = QLabel("Start:")
        intro_start_at_label.setFixedWidth(label_short_width)
        ...
        intro_start_from_label = QLabel("From:")
        intro_start_from_label.setFixedWidth(label_short_width)
        ...
        intro_effect_layout.addSpacing(37)
        intro_effect_layout.addWidget(self.intro_effect_combo)
        intro_effect_layout.addSpacing(5)
        ...
        intro_effect_layout.addSpacing(3)     
        ...
        overlay1_btn.setFixedWidth(file_btn_width)
        ...
        overlay1_size_label.setFixedWidth(label_micro_width)
        overlay1_size_label.setFixedHeight(unified_height)
        self.overlay1_size_combo = NoWheelComboBox()
        self.overlay1_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay1_x_label.setFixedWidth(label_micro_width)
        overlay1_x_label.setFixedHeight(unified_height)
        self.overlay1_x_combo = NoWheelComboBox()
        self.overlay1_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay1_y_label.setFixedWidth(label_micro_width)
        overlay1_y_label.setFixedHeight(unified_height)
        self.overlay1_y_combo = NoWheelComboBox()
        self.overlay1_y_combo.setFixedWidth(combo_mini_width)
        ...
        overlay2_btn.setFixedWidth(file_btn_width)
        ...
        overlay2_size_label.setFixedWidth(label_micro_width)
        overlay2_size_label.setFixedHeight(unified_height)
        self.overlay2_size_combo = NoWheelComboBox()
        self.overlay2_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay2_x_label.setFixedWidth(label_micro_width)
        overlay2_x_label.setFixedHeight(unified_height)
        self.overlay2_x_combo = NoWheelComboBox()
        self.overlay2_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay2_y_label.setFixedWidth(label_micro_width)
        overlay2_y_label.setFixedHeight(unified_height)
        self.overlay2_y_combo = NoWheelComboBox()
        self.overlay2_y_combo.setFixedWidth(combo_mini_width)
        ...
        effect_label.setFixedWidth(label_short_width)
        ...
        overlay1_2_start_from_label = QLabel("From:")
        overlay1_2_start_from_label.setFixedWidth(label_short_width)
        ...
        overlay1_2_duration_full_label.setFixedWidth(label_mini_width)
        ...
        overlay1_2_duration_label.setFixedWidth(label_mini_width)
        ...
        overlay4_btn.setFixedWidth(file_btn_width)
        ...
        overlay4_size_label.setFixedWidth(label_micro_width)
        overlay4_size_label.setFixedHeight(unified_height)
        self.overlay4_size_combo = NoWheelComboBox()
        self.overlay4_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay4_x_label.setFixedWidth(label_micro_width)
        overlay4_x_label.setFixedHeight(unified_height)
        self.overlay4_x_combo = NoWheelComboBox()
        self.overlay4_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay4_y_label.setFixedWidth(label_micro_width)
        overlay4_y_label.setFixedHeight(unified_height)
        self.overlay4_y_combo = NoWheelComboBox()
        self.overlay4_y_combo.setFixedWidth(combo_mini_width)
       ...
       # Overlay 4 layout
        ...
        overlay5_btn.setFixedWidth(file_btn_width)
        ...
        overlay5_size_label.setFixedWidth(label_micro_width)
        overlay5_size_label.setFixedHeight(unified_height)
        self.overlay5_size_combo = NoWheelComboBox()
        self.overlay5_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay5_x_label.setFixedWidth(label_micro_width)
        overlay5_x_label.setFixedHeight(unified_height)
        self.overlay5_x_combo = NoWheelComboBox()
        self.overlay5_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay5_y_label.setFixedWidth(label_micro_width)
        overlay5_y_label.setFixedHeight(unified_height)
        self.overlay5_y_combo = NoWheelComboBox()
        self.overlay5_y_combo.setFixedWidth(combo_mini_width)
        ...
        # Overlay 4_5 effect controls
        overlay4_5_label = QLabel("Effect :")
        overlay4_5_label.setFixedWidth(label_short_width)
        ...
        self.overlay4_5_start_at_checkbox.setFixedWidth(checkbox_solo_width)
        self.overlay4_5_start_at_checkbox.setFixedHeight(unified_height)
        overlay4_5_start_at_label = QLabel("Start:")
        overlay4_5_start_at_label.setFixedWidth(label_short_width)
        overlay4_5_start_at_label.setFixedHeight(unified_height)
        ...
        self.overlay4_5_start_edit.setFixedWidth(edit_short_width)
        ...
        overlay4_5_start_from_label = QLabel("From:")
        overlay4_5_start_from_label.setFixedWidth(label_short_width)
        overlay4_5_start_from_label.setFixedHeight(unified_height)
        self.overlay4_5_start_from_edit = QLineEdit("0")
        self.overlay4_5_start_from_edit.setFixedWidth(edit_short_width)
        ...
        def set_overlay4_5_start_at_enabled(state):
            ...
            if self.overlay4_checkbox.isChecked() or self.overlay5_checkbox.isChecked():
                ...
                if enabled:
                    ...
                    overlay4_5_start_at_label.setStyleSheet("")  # Start at label is active
                    grey_btn_style = "background-color: #f2f2f2; color: #888; border: 1px solid #cfcfcf;"
                    ...
                    overlay4_5_start_at_label.setStyleSheet("color: grey;")  # Grey out start at label

        # Overlay 4_5 duration controls (similar to overlay8 duration)
        self.overlay4_5_duration_full_checkbox = QtWidgets.QCheckBox("")
        self.overlay4_5_duration_full_checkbox.setFixedWidth(checkbox_solo_width)
        self.overlay4_5_duration_full_checkbox.setFixedHeight(unified_height)
        overlay4_5_duration_full_label = QLabel("Full")
        overlay4_5_duration_full_label.setFixedWidth(label_mini_width)
        overlay4_5_duration_full_label.setFixedHeight(unified_height)
        ...
        overlay4_5_duration_label = QLabel("For")
        overlay4_5_duration_label.setFixedWidth(label_mini_width)
        overlay4_5_duration_label.setFixedHeight(unified_height)
        self.overlay4_5_duration_edit = QLineEdit("6")
        self.overlay4_5_duration_edit.setFixedWidth(edit_short_width)
        ...
        def set_overlay4_5_duration_enabled(state):
            ...
            if enabled:
                ...
                overlay4_5_duration_full_label.setStyleSheet("")  # Full label is active when checkbox is checked
            else:
        ...
        overlay4_5_layout.addSpacing(37)
        overlay4_5_layout.addWidget(self.overlay4_5_effect_combo)
        overlay4_5_layout.addSpacing(5)
        overlay4_5_layout.addWidget(overlay4_5_duration_full_label)
        ...
        overlay4_5_layout.addSpacing(25)
        ...
        def update_overlay4_5_effect_label_style():
            if not (self.overlay4_checkbox.isChecked() or self.overlay5_checkbox.isChecked()):
                ...
                overlay4_5_duration_full_label.setStyleSheet("color: grey;")
        ...
        overlay6_btn.setFixedWidth(file_btn_width)
        ...
        overlay6_size_label.setFixedWidth(label_micro_width)
        overlay6_size_label.setFixedHeight(unified_height)
        self.overlay6_size_combo = NoWheelComboBox()
        self.overlay6_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay6_x_label.setFixedWidth(label_micro_width)
        overlay6_x_label.setFixedHeight(unified_height)
        self.overlay6_x_combo = NoWheelComboBox()
        self.overlay6_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay6_y_label.setFixedWidth(label_micro_width)
        overlay6_y_label.setFixedHeight(unified_height)
        self.overlay6_y_combo = NoWheelComboBox()
        self.overlay6_y_combo.setFixedWidth(combo_mini_width)
        ...
        overlay7_btn.setFixedWidth(file_btn_width)
        ...
        overlay7_size_label.setFixedWidth(label_micro_width)
        overlay7_size_label.setFixedHeight(unified_height)
        self.overlay7_size_combo = NoWheelComboBox()
        self.overlay7_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay7_x_label.setFixedWidth(label_micro_width)
        overlay7_x_label.setFixedHeight(unified_height)
        self.overlay7_x_combo = NoWheelComboBox()
        self.overlay7_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay7_y_label.setFixedWidth(label_micro_width)
        overlay7_y_label.setFixedHeight(unified_height)
        self.overlay7_y_combo = NoWheelComboBox()
        self.overlay7_y_combo.setFixedWidth(combo_mini_width)
        ...
        overlay6_7_label.setFixedWidth(label_short_width)
        ...
        overlay6_7_start_at_label = QLabel("Start:")
        overlay6_7_start_at_label.setFixedWidth(label_short_width)
        ...
        overlay6_7_start_from_label = QLabel("From:")
        overlay6_7_start_from_label.setFixedWidth(label_short_width)
        ...
        overlay6_7_duration_full_label.setFixedWidth(label_mini_width)
        ...
        overlay6_7_duration_label.setFixedWidth(label_mini_width)
        ...
        overlay6_7_layout.addSpacing(37)
        ...
        overlay6_7_layout.addSpacing(25)
        ...
        soundwave_method_label.setFixedWidth(label_medium_width)
        ...
        soundwave_color_label.setFixedWidth(label_micro_width)
        soundwave_color_label.setFixedHeight(unified_height)
        self.soundwave_color_combo = NoWheelComboBox()
        self.soundwave_color_combo.setFixedWidth(file_btn_width)
        ...
        soundwave_size_label.setFixedWidth(label_micro_width)
        soundwave_size_label.setFixedHeight(unified_height)
        self.soundwave_size_combo = NoWheelComboBox()
        self.soundwave_size_combo.setFixedWidth(combo_mini_width)
        ...
        soundwave_x_label.setFixedWidth(label_micro_width)
        soundwave_x_label.setFixedHeight(unified_height)
        self.soundwave_x_combo = NoWheelComboBox()
        self.soundwave_x_combo.setFixedWidth(combo_mini_width)
        ...
        soundwave_y_label.setFixedWidth(label_micro_width)
        soundwave_y_label.setFixedHeight(unified_height)
        self.soundwave_y_combo = NoWheelComboBox()
        self.soundwave_y_combo.setFixedWidth(combo_mini_width)
        ...
        overlay3_btn.setFixedWidth(file_btn_width)
        ...
        overlay3_size_label.setFixedWidth(label_micro_width)
        overlay3_size_label.setFixedHeight(unified_height)
        self.overlay3_size_combo = NoWheelComboBox()
        self.overlay3_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay3_x_label.setFixedWidth(label_micro_width)
        overlay3_x_label.setFixedHeight(unified_height)
        self.overlay3_x_combo = NoWheelComboBox()
        self.overlay3_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay3_y_label.setFixedWidth(label_micro_width)
        overlay3_y_label.setFixedHeight(unified_height)
        self.overlay3_y_combo = NoWheelComboBox()
        self.overlay3_y_combo.setFixedWidth(combo_mini_width)
        ...
        song_title_scale_label.setFixedWidth(label_micro_width)
        song_title_scale_label.setFixedHeight(unified_height)
        self.song_title_scale_combo = NoWheelComboBox()
        self.song_title_scale_combo.setFixedWidth(combo_mini_width)
        ...
        song_title_color_label.setFixedWidth(label_micro_width)
        ...
        song_title_bg_color_btn_label = QLabel("C:")
        song_title_bg_color_btn_label.setFixedWidth(label_micro_width)
        song_title_bg_color_btn_label.setFixedHeight(unified_height)
        ...
        # Opacity control
        song_title_opacity_combo_label = QLabel("S:")
        song_title_opacity_combo_label.setFixedWidth(label_micro_width)
        song_title_opacity_combo_label.setFixedHeight(unified_height)
        self.song_title_opacity_combo = NoWheelComboBox()
        self.song_title_opacity_combo.setFixedWidth(combo_mini_width)
        ...
        song_title_text_effect_label = QLabel("FX:")
        song_title_text_effect_label.setFixedWidth(label_mini_width)
        song_title_text_effect_label.setFixedHeight(unified_height)
        self.song_title_text_effect_combo = NoWheelComboBox()
        self.song_title_text_effect_combo.setFixedWidth(combo_medium_width)
        ...
        song_title_text_effect_color_label.setFixedWidth(label_micro_width)
        ...
        song_title_text_effect_intensity_label.setFixedWidth(label_mini_width)
        ...
        self.song_title_text_effect_intensity_combo.setFixedWidth(combo_mini_width)
        ...
        song_title_effect_label.setFixedWidth(label_short_width)
        ...
        song_title_x_label.setFixedWidth(label_micro_width)
        song_title_x_label.setFixedHeight(unified_height)
        self.song_title_x_combo = NoWheelComboBox()
        self.song_title_x_combo.setFixedWidth(combo_mini_width)
        ...
        song_title_y_label.setFixedWidth(label_micro_width)
        song_title_y_label.setFixedHeight(unified_height)
        self.song_title_y_combo = NoWheelComboBox()
        self.song_title_y_combo.setFixedWidth(combo_mini_width)
        ...
        song_title_start_label = QLabel("Start:")
        song_title_start_label.setFixedWidth(label_short_width)
        song_title_start_label.setFixedHeight(unified_height)
        self.song_title_start_edit = QLineEdit("5")
        self.song_title_start_edit.setFixedWidth(combo_short_width)
        ...
        song_title_checkbox_layout.addSpacing(3)        
        ...
        overlay_groupbox_3_titles_wave_layout.addLayout(song_title_checkbox_layout)
        
        # Third line: titles effect and start at
        song_title_effects_layout = QHBoxLayout()
        song_title_effects_layout.setSpacing(0)
        song_title_effects_layout.addSpacing(27)
        song_title_effects_layout.addWidget(song_title_effect_label)
        song_title_effects_layout.addSpacing(37)        
        ...
        song_title_controls_layout.setSpacing(0)
        song_title_controls_layout.addSpacing(43)
        song_title_controls_layout.addWidget(song_title_bg_label)
        song_title_controls_layout.addSpacing(37)
        song_title_controls_layout.addWidget(self.song_title_bg_combo)
        song_title_controls_layout.addSpacing(3)
        song_title_controls_layout.addWidget(song_title_bg_color_btn_label)
        song_title_controls_layout.addWidget(self.song_title_bg_color_btn)
        song_title_controls_layout.addSpacing(3)
        song_title_controls_layout.addWidget(song_title_opacity_combo_label)
        ...
        overlay8_btn.setFixedWidth(file_btn_width)
        ...
        overlay8_size_label.setFixedWidth(label_micro_width)
        overlay8_size_label.setFixedHeight(unified_height)
        self.overlay8_size_combo = NoWheelComboBox()
        self.overlay8_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay8_x_label.setFixedWidth(label_micro_width)
        overlay8_x_label.setFixedHeight(unified_height)
        self.overlay8_x_combo = NoWheelComboBox()
        self.overlay8_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay8_y_label.setFixedWidth(label_micro_width)
        overlay8_y_label.setFixedHeight(unified_height)
        self.overlay8_y_combo = NoWheelComboBox()
        self.overlay8_y_combo.setFixedWidth(combo_mini_width)
        ...
        overlay8_duration_full_label.setFixedWidth(label_mini_width)
        ...
        overlay8_duration_label.setFixedWidth(label_mini_width)
        ...
        overlay8_effect_label = QLabel("Effect :")
        overlay8_effect_label.setFixedWidth(label_short_width)
        ...
        self.overlay8_start_at_checkbox.setFixedWidth(checkbox_solo_width)
        self.overlay8_start_at_checkbox.setFixedHeight(unified_height)
        ...
        self.overlay8_start_combo.setFixedWidth(combo_mini_width)
        ...
        overlay8_start_from_label = QLabel("F:")
        overlay8_start_from_label.setFixedWidth(label_micro_width)
        overlay8_start_from_label.setFixedHeight(unified_height)
        self.overlay8_start_from_combo = NoWheelComboBox()
        self.overlay8_start_from_combo.setFixedWidth(combo_mini_width)
        ...
        overlay8_popup_start_at_label = QLabel("Start:")
        overlay8_popup_start_at_label.setFixedWidth(label_short_width)
        overlay8_popup_start_at_label.setFixedHeight(unified_height)
        self.overlay8_popup_start_at_combo = NoWheelComboBox()
        self.overlay8_popup_start_at_combo.setFixedWidth(combo_mini_width)
        ...
        overlay8_popup_num_label.setFixedWidth(label_short_width)
        overlay8_popup_num_label.setFixedHeight(unified_height)
        self.overlay8_popup_num_combo = NoWheelComboBox()
        self.overlay8_popup_num_combo.setFixedWidth(edit_short_width)
        ...
        overlay9_btn.setFixedWidth(file_btn_width)
        ...
        overlay9_size_label.setFixedWidth(label_micro_width)
        overlay9_size_label.setFixedHeight(unified_height)
        self.overlay9_size_combo = NoWheelComboBox()
        self.overlay9_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay9_x_label.setFixedWidth(label_micro_width)
        overlay9_x_label.setFixedHeight(unified_height)
        self.overlay9_x_combo = NoWheelComboBox()
        self.overlay9_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay9_y_label.setFixedWidth(label_micro_width)
        overlay9_y_label.setFixedHeight(unified_height)
        self.overlay9_y_combo = NoWheelComboBox()
        self.overlay9_y_combo.setFixedWidth(combo_mini_width)
        ...
        overlay9_duration_full_label.setFixedWidth(label_mini_width)
        ...
        overlay9_duration_label.setFixedWidth(label_mini_width)
        ...
        overlay9_effect_label = QLabel("Effect :")
        overlay9_effect_label.setFixedWidth(label_short_width)
        ...
        self.overlay9_start_at_checkbox.setFixedWidth(checkbox_solo_width)
        self.overlay9_start_at_checkbox.setFixedHeight(unified_height)
        ...
        overlay9_start_label = QLabel("Start:")
        overlay9_start_label.setFixedWidth(label_short_width)
        overlay9_start_label.setFixedHeight(unified_height)
        self.overlay9_start_combo = NoWheelComboBox()
        self.overlay9_start_combo.setFixedWidth(combo_mini_width)
        ...
        overlay9_start_from_label = QLabel("F:")
        overlay9_start_from_label.setFixedWidth(label_micro_width)
        overlay9_start_from_label.setFixedHeight(unified_height)
        self.overlay9_start_from_combo = NoWheelComboBox()
        self.overlay9_start_from_combo.setFixedWidth(combo_mini_width)
        ...
        overlay9_popup_start_at_label = QLabel("Start:")
        overlay9_popup_start_at_label.setFixedWidth(label_short_width)
        overlay9_popup_start_at_label.setFixedHeight(unified_height)
        self.overlay9_popup_start_at_combo = NoWheelComboBox()
        self.overlay9_popup_start_at_combo.setFixedWidth(combo_mini_width)
        ...
        overlay9_popup_num_label.setFixedWidth(label_short_width)
        self.overlay9_popup_num_combo = NoWheelComboBox()
        self.overlay9_popup_num_combo.setFixedWidth(edit_short_width)
        ...
        overlay10_btn.setFixedWidth(file_btn_width)
        ...
        overlay10_size_label.setFixedWidth(label_micro_width)
        overlay10_size_label.setFixedHeight(unified_height)
        self.overlay10_size_combo = NoWheelComboBox()
        self.overlay10_size_combo.setFixedWidth(combo_mini_width)
        ...
        overlay10_x_label.setFixedWidth(label_micro_width)
        overlay10_x_label.setFixedHeight(unified_height)
        self.overlay10_x_combo = NoWheelComboBox()
        self.overlay10_x_combo.setFixedWidth(combo_mini_width)
        ...
        overlay10_y_label.setFixedWidth(label_micro_width)
        overlay10_y_label.setFixedHeight(unified_height)
        self.overlay10_y_combo = NoWheelComboBox()
        self.overlay10_y_combo.setFixedWidth(combo_mini_width)
        ...
        overlay10_effect_label = QLabel("Effect :")
        overlay10_effect_label.setFixedWidth(label_short_width)
        ...
        overlay10_duration_label.setFixedWidth(label_mini_width)
        overlay10_duration_label.setFixedHeight(unified_height)
        self.overlay10_duration_edit = QLineEdit("6")
        self.overlay10_duration_edit.setFixedWidth(combo_short_width)
        ...
        overlay10_start_label = QLabel("Start:")
        overlay10_start_label.setFixedWidth(label_short_width)
        overlay10_start_label.setFixedHeight(unified_height)
        self.overlay10_start_edit = QLineEdit("5")
        self.overlay10_start_edit.setFixedWidth(combo_short_width)
        ...
        self.overlay10_start_end_combo.setFixedWidth(combo_mini_width)
        ...
        overlay10_layout = QHBoxLayout()
        overlay10_layout.setSpacing(0)
        overlay10_layout.addSpacing(27)
        overlay10_layout.addWidget(overlay10_effect_label)
        overlay10_layout.addSpacing(37)
        ...
        overlay10_layout.addSpacing(36)
        ...
        overlay10_layout = QHBoxLayout()
        overlay10_layout.setSpacing(0)
        overlay10_layout.addSpacing(110)
        ...
        overlay10_layout.addSpacing(33)
        ...
        frame_mp3cover_custom_label = QLabel("Custom:")
        frame_mp3cover_custom_label.setFixedWidth(label_medium_width)
        frame_mp3cover_custom_label.setFixedHeight(unified_height)
        self.frame_mp3cover_custom_image_checkbox = QtWidgets.QCheckBox("")
        self.frame_mp3cover_custom_image_checkbox.setFixedWidth(checkbox_solo_width)
        ...
        self.frame_mp3cover_custom_image_edit.setFixedWidth(edit_medium_width)
        ...
        self.frame_mp3cover_custom_image_btn.setFixedWidth(file_btn_width)
        ...
        frame_mp3cover_size_label.setFixedWidth(label_micro_width)
        frame_mp3cover_size_label.setFixedHeight(unified_height)
        self.frame_mp3cover_size_combo = NoWheelComboBox()
        self.frame_mp3cover_size_combo.setFixedWidth(combo_mini_width)
        ...
        frame_mp3cover_x_label.setFixedWidth(label_micro_width)
        frame_mp3cover_x_label.setFixedHeight(unified_height)
        self.frame_mp3cover_x_combo = NoWheelComboBox()
        self.frame_mp3cover_x_combo.setFixedWidth(combo_mini_width)
        ...
        frame_mp3cover_y_label.setFixedWidth(label_micro_width)
        frame_mp3cover_y_label.setFixedHeight(unified_height)
        self.frame_mp3cover_y_combo = NoWheelComboBox()
        self.frame_mp3cover_y_combo.setFixedWidth(combo_mini_width)
        ...
        def update_frame_mp3cover_custom_image_controls_state():
            ...
            # Enable/disable custom image controls
            frame_mp3cover_custom_label.setEnabled(both_enabled)
        ...
        def set_frame_mp3cover_enabled(state):
            ...
            frame_mp3cover_custom_label.setEnabled(enabled)
            ...
            if enabled:
                ...
                frame_mp3cover_custom_label.setStyleSheet("")
                ...
                frame_mp3cover_custom_label.setStyleSheet("color: grey;")
        ...
        frame_mp3cover_layout.addSpacing(5)      
        ...
        frame_mp3cover_label.setFixedWidth(label_short_width)
        frame_mp3cover_label.setFixedHeight(unified_height)
        self.frame_mp3cover_effect_combo = NoWheelComboBox()
        self.frame_mp3cover_effect_combo.setFixedWidth(combo_medium_width)
        ...
        frame_mp3cover_duration_label.setFixedWidth(label_mini_width)
        ...
        frame_mp3cover_duration_full_label.setFixedWidth(label_mini_width)
        ...
        frame_mp3cover_start_label = QLabel("Start:")
        ...
        self.frame_mp3cover_start_edit.setFixedWidth(combo_short_width)
        ...
        frame_mp3cover_effect_layout.addSpacing(30)
    ...
    def create_action_buttons(self, layout):
        ...
        self.icon_path = os.path.join(PROJECT_ROOT, "src", "sources", "settings.png")
        self.settings_btn.setIcon(QIcon(self.icon_path))
        ...
        self.layer_icon_path = os.path.join(PROJECT_ROOT, "src", "sources", "logo", "icons8-program-100.png")
        self.layer_manager_btn.setIcon(QIcon(self.layer_icon_path))
        self.layer_manager_btn.setIconSize(QSize(33, 33))
        ...
        self.terminal_btn.setIconSize(QSize(30, 30))
        ...
        button_layout.addWidget(self.preview_btn)
        button_layout.addSpacing(5)
        button_layout.addWidget(self.template_manager_btn)
        button_layout.addSpacing(5)
    ...
    def _set_ui_processing_state(self, processing, total_batches=0):
        ...
        if not processing:
            ...
            # Background layer controls - use the existing state management function
            if hasattr(self, 'bg_layer_checkbox'):
                state = Qt.CheckState.Checked.value if self.bg_layer_checkbox.isChecked() else Qt.CheckState.Unchecked.value
                self.bg_layer_checkbox.stateChanged.emit(state)
    ...
    def get_current_settings(self):
        ...
        settings = {
            ...
            'layer_settings': {
                ...
                'overlay2': {
                    'enabled': hasattr(self, 'overlay2_checkbox') and self.overlay2_checkbox.isChecked(),
                    'path': self.overlay2_edit.text().strip() if hasattr(self, 'overlay2_edit') else "",
                    'size_percent': self.overlay2_size_percent if hasattr(self, 'overlay2_size_percent') else 10,
                ...
                'overlay9': {
                    'enabled': hasattr(self, 'overlay9_checkbox') and self.overlay9_checkbox.isChecked(),
                    'path': self.overlay9_path if hasattr(self, 'overlay9_path') else "",
                    'size_percent': self.overlay9_size_percent if hasattr(self, 'overlay9_size_percent') else 50,
                    'x_percent': self.overlay9_x_percent if hasattr(self, 'overlay9_x_percent') else 0,
                    'y_percent': self.overlay9_y_percent if hasattr(self, 'overlay9_y_percent') else 0,
                    'effect': self.selected_overlay9_effect if hasattr(self, 'selected_overlay9_effect') else "fadein",
                    'duration_full': hasattr(self, 'overlay9_duration_full_checkbox') and self.overlay9_duration_full_checkbox.isChecked(),
                    'duration': self.overlay9_duration if hasattr(self, 'overlay9_duration') else 6,
                    'start_checkbox': hasattr(self, 'overlay9_start_at_checkbox') and self.overlay9_start_at_checkbox.isChecked(),
                    'start_at': self.overlay9_start_percent if hasattr(self, 'overlay9_start_percent') else 5,
                    'start_from': self.overlay9_start_from_percent if hasattr(self, 'overlay9_start_from_percent') else 0,
                    'popup_checkbox': hasattr(self, 'overlay9_popup_checkbox') and self.overlay9_popup_checkbox.isChecked(),
                    'popup_start_at': self.overlay9_popup_start_at_percent if hasattr(self, 'overlay9_popup_start_at_percent') else 5,
                    'popup_num': self.overlay9_popup_num if hasattr(self, 'overlay9_popup_num') else 1
                },
                'overlay10': {
                    'enabled': hasattr(self, 'overlay10_checkbox') and self.overlay10_checkbox.isChecked(),
                    'path': self.overlay10_path if hasattr(self, 'overlay10_path') else "",
                    'size_percent': self.overlay10_size_percent if hasattr(self, 'overlay10_size_percent') else 50,
                    'x_percent': self.overlay10_x_percent if hasattr(self, 'overlay10_x_percent') else 0,
                    'y_percent': self.overlay10_y_percent if hasattr(self, 'overlay10_y_percent') else 0,
                    'effect': self.selected_overlay10_effect if hasattr(self, 'selected_overlay10_effect') else "fadein",
                    'duration': self.overlay10_duration if hasattr(self, 'overlay10_duration') else 6,
                    'start_time': self.overlay10_start_time if hasattr(self, 'overlay10_start_time') else 5,
                    'start_time_percent': self.overlay10_start_time_percent if hasattr(self, 'overlay10_start_time_percent') else 0,
                    'song_start_end_checked': hasattr(self, 'overlay10_song_start_end') and self.overlay10_song_start_end.isChecked(),
                    'start_end_value': self.overlay10_start_end_value if hasattr(self, 'overlay10_start_end_value') else "start"
                },
                'intro': {
                    'enabled': hasattr(self, 'intro_checkbox') and self.intro_checkbox.isChecked(),
                    'path': self.intro_edit.text().strip() if hasattr(self, 'intro_edit') else "",
                    'size_percent': self.intro_size_percent if hasattr(self, 'intro_size_percent') else 50,
                    'x_percent': self.intro_x_percent if hasattr(self, 'intro_x_percent') else 50,
                    'y_percent': self.intro_y_percent if hasattr(self, 'intro_y_percent') else 50,
                    'effect': self.intro_effect if hasattr(self, 'intro_effect') else "fadeout",
                    'duration_full': hasattr(self, 'intro_duration_full_checkbox') and self.intro_duration_full_checkbox.isChecked(),
                    'duration': self.intro_duration if hasattr(self, 'intro_duration') else 6,
                    'start_checkbox': hasattr(self, 'intro_start_checkbox') and self.intro_start_checkbox.isChecked(),
            ...
            'checkbox_labels': {
                'intro_checkbox_label': self.settings.value('intro_checkbox_label', " Intro :", type=str),
                'background_checkbox_label': self.settings.value('background_checkbox_label', " Background :", type=str),
                'overlay1_checkbox_label': self.settings.value('overlay1_checkbox_label', " Overlay 1 :", type=str),
                'overlay2_checkbox_label': self.settings.value('overlay2_checkbox_label', " Overlay 2 :", type=str),
                'overlay3_checkbox_label': self.settings.value('overlay3_checkbox_label', " Overlay 3 :", type=str),
                'overlay4_checkbox_label': self.settings.value('overlay4_checkbox_label', " Overlay 4 :", type=str),
                'overlay5_checkbox_label': self.settings.value('overlay5_checkbox_label', " Overlay 5 :", type=str),
                'overlay6_checkbox_label': self.settings.value('overlay6_checkbox_label', " Overlay 6 :", type=str),
                'overlay7_checkbox_label': self.settings.value('overlay7_checkbox_label', " Overlay 7 :", type=str),
                'overlay8_checkbox_label': self.settings.value('overlay8_checkbox_label', " Overlay 8 :", type=str),
                'overlay9_checkbox_label': self.settings.value('overlay9_checkbox_label', " Overlay 9 :", type=str),
                'overlay10_checkbox_label': self.settings.value('overlay10_checkbox_label', " Overlay 10 :", type=str),
                'frame_box_checkbox_label': self.settings.value('frame_box_checkbox_label', " Frame Box :", type=str),
                'frame_mp3cover_checkbox_label': self.settings.value('frame_mp3cover_checkbox_label', " Frame MP3 Cover :", type=str),
        ...
        try:
            ...
            if 'overlay1' in layer_settings:
                ...
                if hasattr(self, 'overlay1_x_percent'):
                    self.overlay1_x_percent = overlay1_settings.get('x_percent', 0)
                if hasattr(self, 'overlay1_y_percent'):
            ...
            if 'overlay2' in layer_settings:
                ...
                if hasattr(self, 'overlay2_checkbox'):
                    self.overlay2_checkbox.setChecked(overlay2_settings.get('enabled', False))
                if hasattr(self, 'overlay2_edit'):
                    self.overlay2_edit.setText(overlay2_settings.get('path', ''))
                if hasattr(self, 'overlay2_size_percent'):
                    self.overlay2_size_percent = overlay2_settings.get('size_percent', 10)
                if hasattr(self, 'overlay2_x_percent'):
                    self.overlay2_x_percent = overlay2_settings.get('x_percent', 75)
                ...
                if hasattr(self, 'overlay2_size_combo'):
                    ...
                    for i in range(self.overlay2_size_combo.count()):
                        if self.overlay2_size_combo.itemData(i) == size:
                            self.overlay2_size_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay2_x_combo'):
                    x = overlay2_settings.get('x_percent', 75)
                    for i in range(self.overlay2_x_combo.count()):
                        if self.overlay2_x_combo.itemData(i) == x:
                            self.overlay2_x_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay2_y_combo'):
                    y = overlay2_settings.get('y_percent', 0)
                    for i in range(self.overlay2_y_combo.count()):
                ...
                if hasattr(self, 'overlay8_effect_combo'):
                    ...
                    for i in range(self.overlay8_effect_combo.count()):
                        if self.overlay8_effect_combo.itemData(i) == effect:
                            ...
                            break
            if 'overlay9' in layer_settings:
                overlay9_settings = layer_settings['overlay9']
                if hasattr(self, 'overlay9_checkbox'):
                    self.overlay9_checkbox.setChecked(overlay9_settings.get('enabled', False))
                if hasattr(self, 'overlay9_edit'):
                    self.overlay9_edit.setText(overlay9_settings.get('path', ''))
                if hasattr(self, 'overlay9_path'):
                    self.overlay9_path = overlay9_settings.get('path', '')
                if hasattr(self, 'overlay9_size_percent'):
                    self.overlay9_size_percent = overlay9_settings.get('size_percent', 50)
                if hasattr(self, 'overlay9_x_percent'):
                    self.overlay9_x_percent = overlay9_settings.get('x_percent', 0)
                if hasattr(self, 'overlay9_y_percent'):
                    self.overlay9_y_percent = overlay9_settings.get('y_percent', 0)
                if hasattr(self, 'selected_overlay9_effect'):
                    self.selected_overlay9_effect = overlay9_settings.get('effect', 'fadein')
                if hasattr(self, 'overlay9_duration'):
                    self.overlay9_duration = overlay9_settings.get('duration', 6)
                if hasattr(self, 'overlay9_start_percent'):
                    self.overlay9_start_percent = overlay9_settings.get('start_at', 5)
                if hasattr(self, 'overlay9_start_from_percent'):
                    self.overlay9_start_from_percent = overlay9_settings.get('start_from', 0)
                if hasattr(self, 'overlay9_popup_start_at_percent'):
                    self.overlay9_popup_start_at_percent = overlay9_settings.get('popup_start_at', 5)
                if hasattr(self, 'overlay9_popup_num'):
                    self.overlay9_popup_num = overlay9_settings.get('popup_num', 1)
                
                # Update UI controls to reflect the restored values
                if hasattr(self, 'overlay9_size_combo'):
                    size = overlay9_settings.get('size_percent', 50)
                    for i in range(self.overlay9_size_combo.count()):
                        if self.overlay9_size_combo.itemData(i) == size:
                            self.overlay9_size_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay9_x_combo'):
                    x = overlay9_settings.get('x_percent', 0)
                    for i in range(self.overlay9_x_combo.count()):
                        if self.overlay9_x_combo.itemData(i) == x:
                            self.overlay9_x_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay9_y_combo'):
                    y = overlay9_settings.get('y_percent', 0)
                    for i in range(self.overlay9_y_combo.count()):
                        if self.overlay9_y_combo.itemData(i) == y:
                            self.overlay9_y_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay9_duration_edit'):
                    self.overlay9_duration_edit.setText(str(overlay9_settings.get('duration', 6)))
                if hasattr(self, 'overlay9_duration_full_checkbox'):
                    self.overlay9_duration_full_checkbox.setChecked(overlay9_settings.get('duration_full', True))
                if hasattr(self, 'overlay9_start_at_checkbox'):
                    self.overlay9_start_at_checkbox.setChecked(overlay9_settings.get('start_checkbox', True))
                if hasattr(self, 'overlay9_popup_checkbox'):
                    self.overlay9_popup_checkbox.setChecked(overlay9_settings.get('popup_checkbox', False))
                if hasattr(self, 'overlay9_popup_start_at_combo'):
                    popup_start_at = overlay9_settings.get('popup_start_at', 5)
                    for i in range(self.overlay9_popup_start_at_combo.count()):
                        if self.overlay9_popup_start_at_combo.itemData(i) == popup_start_at:
                            self.overlay9_popup_start_at_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay9_popup_num_combo'):
                    popup_num = overlay9_settings.get('popup_num', 1)
                    for i in range(self.overlay9_popup_num_combo.count()):
                        if self.overlay9_popup_num_combo.itemData(i) == popup_num:
                            self.overlay9_popup_num_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay9_start_combo'):
                    start_at = overlay9_settings.get('start_at', 5)
                    for i in range(self.overlay9_start_combo.count()):
                        if self.overlay9_start_combo.itemData(i) == start_at:
                            self.overlay9_start_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay9_start_from_combo'):
                    start_from = overlay9_settings.get('start_from', 0)
                    for i in range(self.overlay9_start_from_combo.count()):
                        if self.overlay9_start_from_combo.itemData(i) == start_from:
                            self.overlay9_start_from_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay9_effect_combo'):
                    effect = overlay9_settings.get('effect', 'fadein')
                    for i in range(self.overlay9_effect_combo.count()):
                        if self.overlay9_effect_combo.itemData(i) == effect:
                            self.overlay9_effect_combo.setCurrentIndex(i)
                            break
            if 'overlay10' in layer_settings:
                overlay10_settings = layer_settings['overlay10']
                if hasattr(self, 'overlay10_checkbox'):
                    self.overlay10_checkbox.setChecked(overlay10_settings.get('enabled', False))
                if hasattr(self, 'overlay10_edit'):
                    self.overlay10_edit.setText(overlay10_settings.get('path', ''))
                if hasattr(self, 'overlay10_path'):
                    self.overlay10_path = overlay10_settings.get('path', '')
                if hasattr(self, 'overlay10_size_percent'):
                    self.overlay10_size_percent = overlay10_settings.get('size_percent', 50)
                if hasattr(self, 'overlay10_x_percent'):
                    self.overlay10_x_percent = overlay10_settings.get('x_percent', 0)
                if hasattr(self, 'overlay10_y_percent'):
                    self.overlay10_y_percent = overlay10_settings.get('y_percent', 0)
                if hasattr(self, 'selected_overlay10_effect'):
                    self.selected_overlay10_effect = overlay10_settings.get('effect', 'fadein')
                if hasattr(self, 'overlay10_duration'):
                    self.overlay10_duration = overlay10_settings.get('duration', 6)
                if hasattr(self, 'overlay10_start_time'):
                    self.overlay10_start_time = overlay10_settings.get('start_time', 5)
                if hasattr(self, 'overlay10_start_time_percent'):
                    self.overlay10_start_time_percent = overlay10_settings.get('start_time_percent', 0)
                if hasattr(self, 'overlay10_start_end_value'):
                    self.overlay10_start_end_value = overlay10_settings.get('start_end_value', 'start')
                
                # Update UI controls to reflect the restored values
                if hasattr(self, 'overlay10_size_combo'):
                    size = overlay10_settings.get('size_percent', 50)
                    for i in range(self.overlay10_size_combo.count()):
                        if self.overlay10_size_combo.itemData(i) == size:
                            self.overlay10_size_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay10_x_combo'):
                    x = overlay10_settings.get('x_percent', 0)
                    for i in range(self.overlay10_x_combo.count()):
                        if self.overlay10_x_combo.itemData(i) == x:
                            self.overlay10_x_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay10_y_combo'):
                    y = overlay10_settings.get('y_percent', 0)
                    for i in range(self.overlay10_y_combo.count()):
                        if self.overlay10_y_combo.itemData(i) == y:
                            self.overlay10_y_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay10_duration_edit'):
                    self.overlay10_duration_edit.setText(str(overlay10_settings.get('duration', 6)))
                if hasattr(self, 'overlay10_start_edit'):
                    self.overlay10_start_edit.setText(str(overlay10_settings.get('start_time', 5)))
                if hasattr(self, 'overlay10_start_percent_combo'):
                    start_time_percent = overlay10_settings.get('start_time_percent', 0)
                    for i in range(self.overlay10_start_percent_combo.count()):
                        if self.overlay10_start_percent_combo.itemData(i) == start_time_percent:
                            self.overlay10_start_percent_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay10_song_start_end'):
                    self.overlay10_song_start_end.setChecked(overlay10_settings.get('song_start_end_checked', False))
                if hasattr(self, 'overlay10_start_end_combo'):
                    start_end_value = overlay10_settings.get('start_end_value', 'start')
                    for i in range(self.overlay10_start_end_combo.count()):
                        if self.overlay10_start_end_combo.itemData(i) == start_end_value:
                            self.overlay10_start_end_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'overlay10_effect_combo'):
                    effect = overlay10_settings.get('effect', 'fadein')
                    for i in range(self.overlay10_effect_combo.count()):
                        if self.overlay10_effect_combo.itemData(i) == effect:
                            self.overlay10_effect_combo.setCurrentIndex(i)
                            break
            if 'intro' in layer_settings:
                intro_settings = layer_settings['intro']
                if hasattr(self, 'intro_checkbox'):
                    self.intro_checkbox.setChecked(intro_settings.get('enabled', False))
                if hasattr(self, 'intro_start_checkbox'):
                    self.intro_start_checkbox.setChecked(intro_settings.get('start_checkbox', False))
                if hasattr(self, 'intro_start_at'):
                    self.intro_start_at = intro_settings.get('start_at', 0)
                if hasattr(self, 'intro_start_from'):
                    self.intro_start_from = intro_settings.get('start_from', 0)
                if hasattr(self, 'intro_duration'):
                    self.intro_duration = intro_settings.get('duration', 6)
                if hasattr(self, 'intro_duration_full_checkbox'):
                    self.intro_duration_full_checkbox.setChecked(intro_settings.get('duration_full', False))
                if hasattr(self, 'intro_effect'):
                    self.intro_effect = intro_settings.get('effect', 'fadeout')
                if hasattr(self, 'intro_size_percent'):
                    self.intro_size_percent = intro_settings.get('size_percent', 50)
                if hasattr(self, 'intro_x_percent'):
                    self.intro_x_percent = intro_settings.get('x_percent', 50)
                if hasattr(self, 'intro_y_percent'):
                    self.intro_y_percent = intro_settings.get('y_percent', 50)
                if hasattr(self, 'intro_edit'):
                    self.intro_edit.setText(intro_settings.get('path', ''))
                
                # Update UI controls to reflect the restored values
                if hasattr(self, 'intro_start_edit'):
                    self.intro_start_edit.setText(str(intro_settings.get('start_at', 0)))
                if hasattr(self, 'intro_start_from_edit'):
                    self.intro_start_from_edit.setText(str(intro_settings.get('start_from', 0)))
                if hasattr(self, 'intro_duration_edit'):
                    self.intro_duration_edit.setText(str(intro_settings.get('duration', 6)))
                if hasattr(self, 'intro_effect_combo'):
                    effect = intro_settings.get('effect', 'fadeout')
                    for i in range(self.intro_effect_combo.count()):
                        if self.intro_effect_combo.itemData(i) == effect:
                            self.intro_effect_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'intro_size_combo'):
                    size = intro_settings.get('size_percent', 50)
                    for i in range(self.intro_size_combo.count()):
                        if self.intro_size_combo.itemData(i) == size:
                            self.intro_size_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'intro_x_combo'):
                    x = intro_settings.get('x_percent', 50)
                    for i in range(self.intro_x_combo.count()):
                        if self.intro_x_combo.itemData(i) == x:
                            self.intro_x_combo.setCurrentIndex(i)
                            break
                if hasattr(self, 'intro_y_combo'):
                    y = intro_settings.get('y_percent', 50)
                    for i in range(self.intro_y_combo.count()):
            ...
            checkbox_labels = template_data.get('checkbox_labels', {})
            for label_name, label_value in checkbox_labels.items():
                self.settings.setValue(label_name, label_value)
            
            # Update layer manager labels if it exists
            if hasattr(self, 'layer_manager_dialog') and self.layer_manager_dialog is not None:
                self.layer_manager_dialog.update_layer_labels()
